                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="start_date" id="datemask1"
                                        ...
                                        value="{{ \Carbon\Carbon::parse($data->start_date)->timezone(session('timezone', 'Asia/Jakarta'))->format('d/m/Y') }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="end_date" id="datemask2"
                                        data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask
                                        value="{{ \Carbon\Carbon::parse($data->end_date)->timezone(session('timezone', 'Asia/Jakarta'))->format('d/m/Y') }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
